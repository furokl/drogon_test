...
class Account
{
  public:
    struct Cols
    {
        ...
        static const std::string _createdon;
    };
    ...
    /**  For column createdon  */
    ///Get the value of the column createdon, returns the default value if the column is null
    const ::trantor::Date &getValueOfCreatedon() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<::trantor::Date> &getCreatedon() const noexcept;
    ///Set the value of the column createdon
